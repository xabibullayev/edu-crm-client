            ...
            <div className='w-full flex flex-col gap-4 p-5 sm:w-4/5 sm:mx-auto md:flex-row lg:w-2/3 lg:gap-14' >
                ...
                <div className='w-full bg-white px-5 py-8 md:py-20 md:w-1/2'>
                    ...
                    <form className='flex flex-col gap-4' onSubmit={submitHandler}>
                        <input type="text" placeholder='Login' className='border border-gray-400 rounded outline-none p-2' />
                        <input type="password" placeholder='Password' className='border border-gray-400 rounded outline-none p-2' />
                        <div className='flex justify-between'>
                            <div className='flex gap-2'>
                                <input type="checkbox" className='w-5 cursor-pointer' />
                                <p>Remember me</p>
                            </div>
                            <Link href='/' className='text-blue-700'>Porgot password?</Link>
                        </div>
                        <Link href='/' className='bg-blue-700 text-white w-24 p-2 rounded text-center'>Login</Link>
                    </form>
                </div>
            </div>
        </div>
